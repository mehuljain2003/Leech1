...
API_ID    = os.environ.get("API_ID", "22940312")
API_HASH  = os.environ.get("API_HASH", "82fb5cd2de25e4c01021b8bbae9909bb")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8062254368:AAE0Tf5lwvtpPbGb-r5hEFi3t4Kso5Tc3mE") 
...
keyboard = InlineKeyboardMarkup(
    [
        ...
        [
            InlineKeyboardButton(text="🪄 Updates Channel", url="https://t.me/+EHezdxFoDsxhOTQ1"),
        ],
    ]
)
...
image_urls = [
    "https://graph.org/file/2bb8026d0b8c8c393c737-3532d812a7f31127c1.jpg",
...
async def add_channel(client, message: Message):
    ...
    if not any(user[0] == user_id for user in subscription_data):
        await message.reply_text(
            ...
            "🔑 Please contact my admin at: **@pradeep1804** for subscription details."
        )
        return
